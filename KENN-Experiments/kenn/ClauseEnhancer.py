...
class ClauseEnhancer(torch.nn.Module):
    ...
    def forward(self, ground_atoms: torch.Tensor, edge_weight: torch.Tensor) -> (torch.Tensor, torch.Tensor):
        ...
        delta = self.conorm_boost(selected_predicates, self.signs, edge_weight)
